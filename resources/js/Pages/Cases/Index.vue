    ...
    <AuthenticatedLayout>
        ...
        <div class="ledger-card mb-4 flex flex-col gap-3 p-3 sm:flex-row sm:items-center">
            <div class="relative flex-1">
                ...
                <input v-model="search" type="text" placeholder="搜索企业名称、统一社会信用代码/EIN/CNPJ 或案件编号…"
                                ...
                                <div class="flex items-center gap-2.5">
                                    ...
                                    <div class="min-w-0">
                                        ...
                                        <p class="truncate font-mono text-[10px] text-ink-400">
                                            {{ c.business?.country === 'US' ? c.business?.ein : (c.business?.country === 'BR' ? c.business?.cnpj : c.business?.uscc) }}
                                        </p>
                                    </div>
                                </div>
                            </td>

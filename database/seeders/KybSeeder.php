...
class KybSeeder extends Seeder
{
    public function run(): void
    {
        ...
        $dataset = [
            [
                'business' => ['深圳云栖科技有限公司', '深圳', '软件和信息技术服务业', '91440300MA5F2Q8812', '林若曦', '人民币 5000 万元', '2018-06-12', '一般经营项目:软件开发、信息系统集成、数据处理与存储。', false, 'CN', null],
                'ubos' => [['林若曦', '370102199003078823', 62.0, false], ['郑明远', '110108198505121234', 28.0, false]],
                'status' => 'approved', 'risk' => 'low', 'month' => 5,
            ],
            [
                'business' => ['Atlantic Global Distributors Inc.', 'US', '跨境贸易', null, 'Michael Anderson', 'USD 2,000,000', '2015-03-20', 'Global electronics distribution and supply chain management services.', false, 'US', '12-3456789'],
                'ubos' => [['Michael Anderson', 'P98765432', 70.0, false], ['Sarah Johnson', 'P12345678', 30.0, false]],
                'status' => 'approved', 'risk' => 'low', 'month' => 5,
            ],
            [
                'business' => ['北京中科智算股份有限公司', '北京', '研究和试验发展', '91110108MA01ABCD56', '宋怀瑾', '人民币 1 亿元', '2016-09-01', '人工智能算法研发、算力基础设施服务、行业解决方案。', false, 'CN', null],
                'ubos' => [['宋怀瑾', '110108198207014567', 51.0, false], [' Horizon Capital', 'P12345678', 30.0, false]],
                'status' => 'approved', 'risk' => 'low', 'month' => 5,
            ],
            [
                'business' => ['上海瀚海供应链管理有限公司', '上海', '多式联运和运输代理', '91310115MA1K3P9099', '苏婉清', '人民币 3000 万元', '2019-03-20', '国际货物运输代理、仓储服务(除危险化学品)、供应链管理咨询。', false, 'CN', null],
                'ubos' => [['苏婉清', '310104199112058811', 45.0, false], ['周慕白', '310115198811119922', 25.0, false]],
                'status' => 'pending_review', 'risk' => 'medium', 'month' => 6,
            ],
            [
                'business' => ['广州新橙文创科技有限公司', '广州', '广播、电视、电影和录音制作业', '91440101MA9Y2K3344', '韩星辰', '人民币 1000 万元', '2021-11-08', '数字内容创作、动漫游戏开发、文化创意设计。', false, 'CN', null],
                'ubos' => [['韩星辰', '440106199507304411', 70.0, false]],
                'status' => 'reviewing', 'risk' => 'low', 'month' => 6,
            ],
            [
                'business' => ['离岸国际控股有限公司', 'KY', '投资与控股', 'KY-3210987-OFFSHORE', 'Marcus Lin', 'USD 5,000', '2014-02-14', '跨境投资控股、资产重组与离岸结构设计。', false, 'OTHER', null],
                'ubos' => [['Marcus Lin', 'P88765432', 80.0, false]],
                'status' => 'reviewing', 'risk' => 'high', 'month' => 6,
            ],
            [
                'business' => ['盛远争议数字科技有限公司', '杭州', '虚拟资产/争议行业', '91330106MA2H8J7799', '钱景行', '人民币 800 万元', '2020-04-30', '虚拟资产交易撮合、数字藏品发行(存在争议业务)。', true, 'CN', null],
                'ubos' => [['钱景行', '330106198904203345', 90.0, true]],
                'status' => 'reviewing', 'risk' => 'high', 'month' => 6,
            ],
            [
                'business' => ['某受限国际贸易有限公司', '深圳', '跨境贸易', '91440300MA9ZZ112233', '吴畏', '人民币 200 万元', '2017-07-19', '货物与技术进出口、跨境支付结算、国际物流。', true, 'CN', null],
                'ubos' => [['吴畏', '440304198502091122', 55.0, true]],
                'status' => 'rejected', 'risk' => 'prohibited', 'month' => 4,
            ],
            [
                'business' => ['速达空壳商务咨询中心', '成都', '商务服务业', '91510104MA6X3D0045', '孙一鸣', '人民币 1 万元', '2022-10-11', '商务信息咨询(无实际经营场所与人员)。', false, 'CN', null],
                'ubos' => [['孙一鸣', '510104199001011234', 100.0, false]],
                'status' => 'pending_review', 'risk' => 'high', 'month' => 6,
            ],
            [
                'business' => ['武汉光子跃动科技有限公司', '武汉', '软件和信息技术服务业', '91420100MA4K9Q5566', '冯予安', '人民币 8000 万元', '2015-12-28', '光电器件研发、半导体设备、精密仪器制造。', false, 'CN', null],
                'ubos' => [['冯予安', '420102198710106677', 40.0, false], ['邓书宁', '420103198501028899', 35.0, false]],
                'status' => 'screening', 'risk' => null, 'month' => 6,
            ],
            [
                'business' => ['南京清川能源科技有限公司', '南京', '电力、热力生产和供应业', '91320100MA1WQ7T012', '蒋砚舟', '人民币 1.2 亿元', '2013-05-06', '光伏发电、储能系统、清洁能源工程总承包。', false, 'CN', null],
        ...
        foreach ($dataset as $row) {
            ...
            $business = Business::create([
                ...
                'uscc' => $uscc, 'ein' => $ein, 'legal_rep' => $legalRep, 'registered_capital' => $capital,
                'establish_date' => $establish, 'address' => $region.($country === 'CN' ? '市高新区科韵路'.rand(1, 999).'号' : '123 Business Ave, Suite 100'),
